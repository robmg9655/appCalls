        ...
        <SafeAreaView className="bg-black h-full">
            <ScrollView contentContainerClassName='h-full'>
                ...
                <View className="px-10">
                    ...
                    <TouchableOpacity onPress={handleLogin} className="bg-accent-200 shadow-md shadow-zinc-300 rounded-full w-full py-4 mt-5">
                        <View className="flex flex-row items-center justify-center">
                            <Image
                                ...
                                resizeMode="contain"
                            />
                            <Text className="text-lg font-NimbusSanL-Bold text-black-300 ml-2">Continuar amb Google</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
